...
BASE = [
    ...
    KC.P0, KC.P3, KC.PDOT, KC.PPLS, KC.MO(1) , KC.LCTL, KC.LALT, KC.LCMD, KC.NO, KC.SPC, KC.RCMD, KC.RALT, KC.LEFT, KC.DOWN, KC.RIGHT, GIT_ADD, #for git add commit (lion key)
]
...
FN = [
    ...
    KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS,
    KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, 
    KC.TRNS, KC.TRNS, KC.TRNS, KC.PENT, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, GIT_PUSH,
